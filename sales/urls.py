...
from .views import display_products, create_sale, view_sales, delete_sale, edit_sale, display_sale, sales_history
...
urlpatterns = [
    ...
    path('report/', sales_history, name='sales_history'),
]
